...
/**
 * Implementation of tab1 Tab configuration page
 */
export const Tab1TabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/tab1Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/tab1Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "tab1 Tab",
            removeUrl: host + "/tab1Tab/remove.html?theme={theme}",
